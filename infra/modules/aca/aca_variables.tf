...
variable "sb_load_connection_string" {
  description = "Service Bus connection string for load test topic."
}

variable "eh_load_connection_string" {
  description = "Event Hub connection string for load test event hub."
}